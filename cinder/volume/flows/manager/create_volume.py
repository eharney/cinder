...
class CreateVolumeFromSpecTask(flow_utils.CinderTask):
    ...
    def _setup_encryption_keys(self, context, volume, encryption):
        ...
        try:
            ...
            if image_info.encrypted == 'yes':
                ...
                with tempfile.NamedTemporaryFile(dir=tmp_dir) as tmp_key:
                    ...
                    with tempfile.NamedTemporaryFile(dir=tmp_dir) as \
                            tmp_new_key:
    ...
    def _create_from_source_volume(self, context, volume, source_volid,
        ...
        try:
            ...
            # TODO(eharney): may need to apply model_update to volume here?
